...
ob_start();
?>
	<nav class="u-align-right u-menu u-menu-one-level u-offcanvas u-menu-2" data-position="topmenuright">
                  <div class="menu-collapse">
                    <a class="u-button-style u-custom-border u-custom-border-color u-custom-borders u-custom-color u-custom-hover-color u-custom-left-right-menu-spacing u-custom-text-hover-color u-custom-top-bottom-menu-spacing u-nav-link" href="#">
                      <svg class="u-svg-link" viewBox="0 0 24 24"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-5ab0"></use></svg>
                      <svg class="u-svg-content" version="1.1" id="svg-5ab0" viewBox="0 0 16 16" x="0px" y="0px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"><g><rect y="1" width="16" height="2"></rect><rect y="7" width="16" height="2"></rect><rect y="13" width="16" height="2"></rect>
</g></svg>
                    </a>
                  </div>
...
if (!function_exists('renderMegaPopup2')) {
    function renderMegaPopup2($match)
    {
...
if (!function_exists('buildMenu2')) {
    function buildMenu2($list, $default_id, $active_id, $path, $options)
	{
        ...
        $menuResult = preg_replace_callback('/<\!--start\_megapopup_([\d]+)-->([\s\S]+?)<\!--end\_megapopup-->/', 'renderMegaPopup2', $menuResult);
        return $menuResult;
    }
}
$mainList = unserialize(serialize($list));
$menu_html = buildMenu2($mainList, $default_id, $active_id, $path, array(
        'container_class' => 'u-align-right u-menu u-menu-one-level u-offcanvas u-menu-2',
        'menu_class' => 'u-nav u-spacing-5 u-unstyled u-nav-3',
        'item_class' => 'u-nav-item',
        'link_class' => 'u-border-2 u-border-active-black u-border-hover-black u-border-palette-5-base u-button-style u-hover-white u-nav-link',
        'link_style' => 'padding: 5px;',
        'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-553f-38',
...
$resp_menu = buildMenu2($list, $default_id, $active_id, $path, array(
        'container_class' => 'u-align-right u-menu u-menu-one-level u-offcanvas u-menu-2',
        'menu_class' => 'u-align-center u-nav u-popupmenu-items u-unstyled u-nav-4',
        'item_class' => 'u-nav-item',
        'link_class' => 'u-button-style u-nav-link',
        'link_style' => '',
        'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-553f-43',
        'submenu_item_class' => 'u-nav-item',
        'submenu_link_class' => 'u-button-style u-nav-link u-white',
        'submenu_link_style' => ''
    )
